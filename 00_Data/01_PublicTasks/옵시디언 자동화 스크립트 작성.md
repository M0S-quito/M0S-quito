...
---
### SubTask
- [x] 1. 템플릿 파일 기반으로 바로 해당 폴더에 파일 생성시 알맞는 템플릿 적용해서 생성하는 스크립트 작성
- [ ] 2. Task의 프론트메터 읽어서 완료한 것들 해당 날짜 파일에 넣는 스크립트 작성
- [ ] 3. Routines 파일에 파일이 생기면 자동으로 Log에 해당 항목 추가하는 스크립트 작성
- [ ] 4. 당일 Log에 Routines 항목에 체크가 되면 해당 Routine에 날짜 +1해주는 스크립트 작성
- [ ] 5. done상태가 아닌 Task들 Readme에 자동 작성, github 백업해 주는 스크립트 작성
- [ ] 6. deploy인 파일들 파싱해서 내 블로그에 포스팅 해주는 스크립트 작성
